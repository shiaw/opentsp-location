...
public class DP_2404_TerminalCloseAllWireless extends DPCommand {

	@Override
	public PacketResult processor(NettyClientConnection connection,Packet packet) {
		//缓存指令信息
		AnswerEntry answerEntry = new AnswerEntry();
		answerEntry.setInternalCommand(LCAllCommands.AllCommands.Terminal.TerminalCloseAllWireless_VALUE);
		...
		bytesArray.append(Convert.intTobytes(7, 1));//关闭所有无线通信
