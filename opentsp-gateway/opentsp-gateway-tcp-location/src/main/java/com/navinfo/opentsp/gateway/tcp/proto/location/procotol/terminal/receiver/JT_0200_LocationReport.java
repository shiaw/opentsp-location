...
import com.navinfo.opentsp.gateway.tcp.proto.location.pojo.ModuleVoltageEntity;
import com.navinfo.opentsp.gateway.tcp.proto.location.pojo.PacketResult;
import com.navinfo.opentsp.gateway.tcp.proto.location.pojo.TerminalLastestCANData;
...
public class JT_0200_LocationReport extends TerminalCommand {
    protected static int GPS_TIME_OUT = 600;
    ...
    public PacketResult processor(NettyClientConnection connection, Packet packet) {
        try {
            ...
            // 0200上报的位置数据不做补偿判断 hk
            builder.setIsPatch(false);
            //默认为没有合并
            builder.setBatteryPower(1);

            // isLocation
            builder.setStarStatus((int) (status & 0x000002));
            // 0x000002 1
            // 0：未定位；1：定位;starStatus
            // 星况（1正常，0不正常，默认为1）
...
//                                }
//
//                                log.info("vin-->{}, sync_0200_data --> {}", packet.getUniqueMark(), JSON.toJSONString(sync));
//                            }
                            ...
                            break;
                        case 2:
                            int oil = Convert.byte2Int(ArraysUtils.subarrays(addition, additionIndex + 2, additionLength),
                                    additionLength);
                            additionIndex = additionIndex + 2 + additionLength;
                            builder.setOil(oil);
                            break;
                        case 3:
                            int recorderSpeed = Convert.byte2Int(
                        ...
                        case 0x31:
                            // 星数（默认为1）
                            int starNumber = Convert.byte2Int(
                                    ArraysUtils.subarrays(addition, additionIndex + 2, additionLength), additionLength);
                            additionIndex = additionIndex + 2 + additionLength;
                            builder.setStarNumber(starNumber);
                            break;
                        case 0xEF:
                            // EF 附加信息ID = 0x EF， 附加信息长度=8 扩展状态第二个字节 16进制：EF
                            // 08 00 40 00 00 00 00 00 00
                            // 取出附加信息
                            byte[] alermstatusAddition = ArraysUtils.subarrays(addition, additionIndex + 2, additionLength);
                            // 40
                            // 00
                            // 00
                            // 00
							...
							// 设置 附加报警位到LocationData的additonAlarm字段上
...
//                            }
                        ...
                        case 0xF0:
                            ...
                            // buffer.append("[F0:"+Convert.byte2Int(turningAngle,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xF3:
                            ...
                            // buffer.append("[F3:"+Convert.byte2Int(rpmWhenAlarming,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xF4:
                            ...
                            // buffer.append("[F4:"+Convert.byte2Int(velocityChangeValue,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xF5:
                            ...
                            // buffer.append("[F5:"+Convert.byte2Int(currentGearshift,
                            // 1)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xF6:
                            ...
                            // buffer.append("[F6:"+Convert.byte2Int(currentRPM,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                            lCDrivingBehaviorAnalysis.setCurrentRPM(Convert.byte2Int(currentRPM, 2));
                            break;
                        case 0xF7:
                            // 当车辆ACC开启时，终端查询并存储的北斗终端ID号，如果查询不到填0xFF。
                        ...
                        case 0xF8:
                            ...
                            // buffer.append("[F8:"+Convert.byte2Int(brakeTimes,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xF9:
                            ...
                            // buffer.append("[F9:"+Convert.byte2Int(clutchTimes,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xFA:
                            ...
                            // buffer.append("[FA:"+Convert.byte2Int(retarderTimes,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xFB:
                            ...
                            // buffer.append("[FB:"+Convert.byte2Int(absTimes,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
                        ...
                        case 0xFC:
                            ...
                            // buffer.append("[FC:"+Convert.byte2Int(reverseTimes,
                            // 2)+"]");
                            additionIndex = additionIndex + 2 + additionLength;
            ...
            outPacket.setCommand(AllCommands.Terminal.ReportLocationData_VALUE);
    ...
    // Configuration.getInt("LEFT.TOP.LONGITUDE");
    // private int rightBottomLatitude =
    // Configuration.getInt("RIGHT.BOTTOM.LATITUDE");
    // private int rightBottomLongitude =
    // Configuration.getInt("RIGHT.BOTTOM.LONGITUDE");
     ...
     * @return
     */
    // private int isValidGps(int latitude , int longitude , long gpsTime , long
    // currentTime){
    // if(latitude > leftTopLatitude || latitude < rightBottomLatitude ||
    // longitude < leftTopLongitude || longitude > rightBottomLongitude){
    // return 2;
