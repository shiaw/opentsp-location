...
import com.navinfo.opentsp.platform.location.protocol.terminal.setting.LCDeleteCircleAreaAlarm;
...
public class DP_2306_DeleteCircleAreaAlarm extends DPCommand {

	@Override
	public PacketResult processor(NettyClientConnection connection,Packet packet) {
		AnswerEntry answerEntry = new AnswerEntry();
		answerEntry.setInternalCommand(LCAllCommands.AllCommands.Terminal.DeleteCircleAreaAlarm_VALUE);// ************
		answerEntry.setSerialNumber(packet.getSerialNumber());
		answerEntry.setTerminalCommand(Constant.JTProtocol.DeleteTerminalCircleArea);
		...
		try {
			DeleteCircleAreaAlarm deleteCircleAreaAlarm = DeleteCircleAreaAlarm.parseFrom(packet.getContent());
			List<Long> areaIdentifyList = deleteCircleAreaAlarm.getAreaIdentifyList();
			...
			outpacket.setCommand(Constant.JTProtocol.DeleteTerminalCircleArea);
