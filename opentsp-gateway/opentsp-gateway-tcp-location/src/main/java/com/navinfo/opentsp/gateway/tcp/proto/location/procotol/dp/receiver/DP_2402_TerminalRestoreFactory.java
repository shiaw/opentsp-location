...
public class DP_2402_TerminalRestoreFactory extends DPCommand {

	@Override
	public PacketResult processor(NettyClientConnection connection,Packet packet) {
		AnswerEntry answerEntry = new AnswerEntry();
		answerEntry.setInternalCommand(LCAllCommands.AllCommands.Terminal.TerminalRestoreFactory_VALUE);
		...
		bytesArray.append(Convert.intTobytes(5, 1));
