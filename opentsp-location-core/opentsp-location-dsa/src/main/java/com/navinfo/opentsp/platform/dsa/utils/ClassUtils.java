 ...
 *
 * @author admin
 * @version CopyRight (c) 2015 , hbdrawn@vip.qq.com All Rights Reserved
 * @date 2015年9月25日 下午5:24:34
 **/

public class ClassUtils {

    public static void main(String[] args) throws Exception {
        List<Class<?>> classes = ClassUtils.getAllClassByInterface(Class
     ...
     * 取得某个接口下所有实现这个接口的类
     */
    public static List<Class<?>> getAllClassByAbstract(Class<?> c) {
        List<Class<?>> returnClassList = null;
        ...
        if (allClass != null) {
            ...
            for (Class<?> classes : allClass) {
                // 判断接口是否已经废弃
                Deprecated annotation = classes.getAnnotation(Deprecated.class);
                if (annotation != null) {
                    continue;
                }
