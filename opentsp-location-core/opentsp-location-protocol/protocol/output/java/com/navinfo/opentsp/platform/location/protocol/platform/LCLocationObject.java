...
// source: core/proto/platform/java/LocationObject.proto

package com.navinfo.opentsp.platform.location.protocol.platform;

public final class LCLocationObject {
  private LCLocationObject() {}
  ...
  public interface LocationObjectOrBuilder
    ...
    // optional .LocationData locationData = 2;
  ...
  public static final class LocationObject extends
    ...
    private LocationObject(Builder builder) {
      super(builder);
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.internal_static_LocationObject_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.internal_static_LocationObject_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObjectOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.internal_static_LocationObject_descriptor;
      }
      ...
      // Construct using com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject build() {
        com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject result = new com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject.getDefaultInstance()) return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n-core/proto/platform/java/LocationObjec" +
      "t.proto\032)core/proto/common/java/Location" +
      "Data.proto\"O\n\016LocationObject\022\030\n\020terminal" +
      "Identify\030\001 \002(\003\022#\n\014locationData\030\002 \001(\0132\r.L" +
      "ocationDataBK\n7com.navinfo.opentsp.platf" +
      "orm.location.protocol.platformB\020LCLocati" +
      "onObject"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_LocationObject_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_LocationObject_descriptor,
              new java.lang.String[] { "TerminalIdentify", "LocationData", },
              com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject.class,
              com.navinfo.opentsp.platform.location.protocol.platform.LCLocationObject.LocationObject.Builder.class);
          return null;
        }
      };
