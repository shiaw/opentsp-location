...
public final class LCTRCollectOnlyCodeRes {
  ...
  public static final class TRCollectOnlyCodeRes extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.internal_static_TRCollectOnlyCodeRes_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.internal_static_TRCollectOnlyCodeRes_fieldAccessorTable;
    }
    ...
    private java.lang.Object manufacturerAuthCode_;
    public boolean hasManufacturerAuthCode() {
      return ((bitField0_ & 0x00000004) == 0x00000004);
    }
    public String getManufacturerAuthCode() {
      java.lang.Object ref = manufacturerAuthCode_;
    ...
    private java.lang.Object productsAuthCode_;
    public boolean hasProductsAuthCode() {
      return ((bitField0_ & 0x00000008) == 0x00000008);
    }
    public String getProductsAuthCode() {
      java.lang.Object ref = productsAuthCode_;
      if (ref instanceof String) {
        return (String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeResOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.internal_static_TRCollectOnlyCodeRes_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes build() {
        com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes result = new com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_TRCollectOnlyCodeRes_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_TRCollectOnlyCodeRes_descriptor,
              new java.lang.String[] { "SerialNumber", "Result", "ManufacturerAuthCode", "ProductsAuthCode", "ProductDate", "ProductsCode", },
              com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes.class,
              com.navinfo.opentsp.platform.location.protocol.terminal.query.travelrecorder.LCTRCollectOnlyCodeRes.TRCollectOnlyCodeRes.Builder.class);
          return null;
        }
      };
