...
public final class LCMultiServerAuth {
  ...
  public static final class MultiServerAuth extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.internal_static_MultiServerAuth_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.internal_static_MultiServerAuth_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuthOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.internal_static_MultiServerAuth_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth build() {
        com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth result = new com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_MultiServerAuth_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_MultiServerAuth_descriptor,
              new java.lang.String[] { "ServerIp", "ChannelIdentify", },
              com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth.class,
              com.navinfo.opentsp.platform.location.protocol.platform.auth.LCMultiServerAuth.MultiServerAuth.Builder.class);
          return null;
        }
      };
