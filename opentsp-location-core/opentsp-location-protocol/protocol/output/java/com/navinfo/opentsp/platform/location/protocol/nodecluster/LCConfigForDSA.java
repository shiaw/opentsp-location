...
// source: core/proto/nodecluster/java/ConfigForDSA.proto

package com.navinfo.opentsp.platform.location.protocol.nodecluster;

public final class LCConfigForDSA {
  private LCConfigForDSA() {}
  public static void registerAllExtensions(
      com.google.protobuf.ExtensionRegistry registry) {
  }
  public interface ConfigForDSAOrBuilder
  ...
  public static final class ConfigForDSA extends
      com.google.protobuf.GeneratedMessage
      implements ConfigForDSAOrBuilder {
    // Use ConfigForDSA.newBuilder() to construct.
    private ConfigForDSA(Builder builder) {
      super(builder);
    }
    private ConfigForDSA(boolean noInit) {}
    
    private static final ConfigForDSA defaultInstance;
    public static ConfigForDSA getDefaultInstance() {
      return defaultInstance;
    }
    
    public ConfigForDSA getDefaultInstanceForType() {
      return defaultInstance;
    }
    
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.internal_static_ConfigForDSA_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.internal_static_ConfigForDSA_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSAOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.internal_static_ConfigForDSA_descriptor;
      }
      ...
      // Construct using com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA build() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA result = new com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA.getDefaultInstance()) return this;
        if (other.hasDaCode()) {
      ...
      // @@protoc_insertion_point(builder_scope:ConfigForDSA)
    }
    
    static {
      defaultInstance = new ConfigForDSA(true);
      defaultInstance.initFields();
    }
    
    // @@protoc_insertion_point(class_scope:ConfigForDSA)
  }
  
  private static com.google.protobuf.Descriptors.Descriptor
    internal_static_ConfigForDSA_descriptor;
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_ConfigForDSA_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "SA.proto\0328core/proto/nodecluster/common/" +
      "java/ParameterConfig.proto\"?\n\014ConfigForD" +
      "SA\022\016\n\006daCode\030\001 \002(\003\022\037\n\005paras\030\002 \003(\0132\020.Para" +
      "meterConfigBL\n:com.navinfo.opentsp.platf" +
      "orm.location.protocol.nodeclusterB\016LCCon" +
      "figForDSA"
    };
    com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner assigner =
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForDSA_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ConfigForDSA_descriptor,
              new java.lang.String[] { "DaCode", "Paras", },
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA.class,
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDSA.ConfigForDSA.Builder.class);
          return null;
        }
      };
