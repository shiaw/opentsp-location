...
public final class LCDrivingBehaviorSetting {
  ...
  public static final class DrivingBehaviorSetting extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.internal_static_DrivingBehaviorSetting_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.internal_static_DrivingBehaviorSetting_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSettingOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.internal_static_DrivingBehaviorSetting_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting build() {
        com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting result = new com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_DrivingBehaviorSetting_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_DrivingBehaviorSetting_descriptor,
              new java.lang.String[] { "Acceleration", "Deceleration", "SharpTurning", "LowOil", "SlideNeutral", "RpmThreshold", "Throttle", "DisparitySpeed", "BrakePressure", "LongTimeBreaking", "LongTimeClutch", "ParkedTimke", "ColdBootTime", "IdlingTime", },
              com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting.class,
              com.navinfo.opentsp.platform.location.protocol.terminal.monitor.LCDrivingBehaviorSetting.DrivingBehaviorSetting.Builder.class);
          return null;
        }
      };
