...
public final class LCAlarmTriggeredSetting {
  ...
  public static final class AlarmTriggeredSetting extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.internal_static_AlarmTriggeredSetting_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.internal_static_AlarmTriggeredSetting_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSettingOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.internal_static_AlarmTriggeredSetting_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting build() {
        com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting result = new com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_AlarmTriggeredSetting_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_AlarmTriggeredSetting_descriptor,
              new java.lang.String[] { "AlarmMask", "AlarmSmsSwitch", "AlarmPhotoSwitch", "AlarmPhotoSave", "AlarmKeyStatus", },
              com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting.class,
              com.navinfo.opentsp.platform.location.protocol.terminal.setting.parameter.LCAlarmTriggeredSetting.AlarmTriggeredSetting.Builder.class);
          return null;
        }
      };
