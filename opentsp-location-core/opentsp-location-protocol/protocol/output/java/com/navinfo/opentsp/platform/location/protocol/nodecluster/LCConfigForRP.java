...
public final class LCConfigForRP {
  ...
  public interface ConfigForRPOrBuilder
    ...
    java.util.List<java.lang.Long> getDpCodeList();
    int getDpCodeCount();
  ...
  public static final class ConfigForRP extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.internal_static_ConfigForRP_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.internal_static_ConfigForRP_fieldAccessorTable;
    }
    
    private int bitField0_;
    // repeated int64 dpCode = 1;
    public static final int DPCODE_FIELD_NUMBER = 1;
    private java.util.List<java.lang.Long> dpCode_;
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRPOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.internal_static_ConfigForRP_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP build() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP result = new com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP.getDefaultInstance()) return this;
      ...
      // repeated int64 dpCode = 1;
      private java.util.List<java.lang.Long> dpCode_ = java.util.Collections.emptyList();;
      private void ensureDpCodeIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          dpCode_ = new java.util.ArrayList<java.lang.Long>(dpCode_);
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForRP_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ConfigForRP_descriptor,
              new java.lang.String[] { "DpCode", "RpForServerCode", "DaCode", "Paras", },
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP.class,
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForRP.ConfigForRP.Builder.class);
          return null;
        }
      };
