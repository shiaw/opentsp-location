...
// source: core/proto/nodecluster/java/ConfigForDP.proto
...
public final class LCConfigForDP {
  ...
  public interface ConfigForDPOrBuilder
    ...
    // required int64 encryptPortCode = 2;
    boolean hasEncryptPortCode();
    long getEncryptPortCode();
  ...
  public static final class ConfigForDP extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.internal_static_ConfigForDP_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.internal_static_ConfigForDP_fieldAccessorTable;
    }
    ...
    // required int64 encryptPortCode = 2;
    public static final int ENCRYPTPORTCODE_FIELD_NUMBER = 2;
    private long encryptPortCode_;
    public boolean hasEncryptPortCode() {
      return ((bitField0_ & 0x00000002) == 0x00000002);
    }
    public long getEncryptPortCode() {
      return encryptPortCode_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeInt64(2, encryptPortCode_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt64Size(2, encryptPortCode_);
      }
      for (int i = 0; i < paras_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDPOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.internal_static_ConfigForDP_descriptor;
      }
      ...
      // Construct using com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP build() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP result = new com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP(this);
        ...
        result.encryptPortCode_ = encryptPortCode_;
        if (parasBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP.getDefaultInstance()) return this;
        if (other.hasDaCode()) {
          setDaCode(other.getDaCode());
        }
        if (other.hasEncryptPortCode()) {
          setEncryptPortCode(other.getEncryptPortCode());
        }
        if (parasBuilder_ == null) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              encryptPortCode_ = input.readInt64();
              break;
            }
            case 26: {
      ...
      public Builder setEncryptPortCode(long value) {
        bitField0_ |= 0x00000002;
        encryptPortCode_ = value;
        onChanged();
        return this;
      }
      public Builder clearEncryptPortCode() {
        bitField0_ = (bitField0_ & ~0x00000002);
        encryptPortCode_ = 0L;
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n-core/proto/nodecluster/java/ConfigForD" +
      "P.proto\0328core/proto/nodecluster/common/j" +
      "ava/ParameterConfig.proto\"W\n\013ConfigForDP" +
      "\022\016\n\006daCode\030\001 \002(\003\022\027\n\017encryptPortCode\030\002 \002(" +
      "\003\022\037\n\005paras\030\003 \003(\0132\020.ParameterConfigBK\n:co" +
      "m.navinfo.opentsp.platform.location.prot" +
      "ocol.nodeclusterB\rLCConfigForDP"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForDP_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ConfigForDP_descriptor,
              new java.lang.String[] { "DaCode", "EncryptPortCode", "Paras", },
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP.class,
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDP.ConfigForDP.Builder.class);
          return null;
        }
      };
