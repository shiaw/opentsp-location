...
// source: core/proto/nodecluster/java/ConfigForDA.proto
...
public final class LCConfigForDA {
  ...
  public static final class ConfigForDA extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.internal_static_ConfigForDA_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.internal_static_ConfigForDA_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDAOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.internal_static_ConfigForDA_descriptor;
      }
      ...
      // Construct using com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA build() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA result = new com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA.getDefaultInstance()) return this;
        if (parasBuilder_ == null) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ava/ParameterConfig.proto\".\n\013ConfigForDA" +
      "\022\037\n\005paras\030\001 \003(\0132\020.ParameterConfigBK\n:com" +
      ".navinfo.opentsp.platform.location.proto" +
      "col.nodeclusterB\rLCConfigForDA"
    };
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForDA_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA.class,
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForDA.ConfigForDA.Builder.class);
          return null;
        }
      };
