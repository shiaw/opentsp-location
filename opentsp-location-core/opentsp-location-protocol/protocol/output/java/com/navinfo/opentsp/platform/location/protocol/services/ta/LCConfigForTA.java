...
// source: core/proto/services/ta/java/ConfigForTA.proto

package com.navinfo.opentsp.platform.location.protocol.services.ta;

public final class LCConfigForTA {
  private LCConfigForTA() {}
  public static void registerAllExtensions(
      com.google.protobuf.ExtensionRegistry registry) {
  }
  public interface ConfigForTAOrBuilder
    ...
    // required string daIP = 3;
    boolean hasDaIP();
    String getDaIP();
    
    // required int32 daPort = 4;
    boolean hasDaPort();
    int getDaPort();
    
    // required string taForTerminalIP = 5;
    boolean hasTaForTerminalIP();
    String getTaForTerminalIP();
    
    // required int32 taForTerminalPort = 6;
    boolean hasTaForTerminalPort();
    int getTaForTerminalPort();
  ...
  public static final class ConfigForTA extends
      com.google.protobuf.GeneratedMessage
      implements ConfigForTAOrBuilder {
    // Use ConfigForTA.newBuilder() to construct.
    private ConfigForTA(Builder builder) {
      super(builder);
    }
    private ConfigForTA(boolean noInit) {}
    
    private static final ConfigForTA defaultInstance;
    public static ConfigForTA getDefaultInstance() {
      return defaultInstance;
    }
    
    public ConfigForTA getDefaultInstanceForType() {
      return defaultInstance;
    }
    
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.internal_static_ConfigForTA_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.internal_static_ConfigForTA_fieldAccessorTable;
    }
    ...
    // required string daIP = 3;
    public static final int DAIP_FIELD_NUMBER = 3;
    ...
    // required int32 daPort = 4;
    public static final int DAPORT_FIELD_NUMBER = 4;
    private int daPort_;
    ...
    // required string taForTerminalIP = 5;
    public static final int TAFORTERMINALIP_FIELD_NUMBER = 5;
    private java.lang.Object taForTerminalIP_;
    public boolean hasTaForTerminalIP() {
      return ((bitField0_ & 0x00000010) == 0x00000010);
    }
    public String getTaForTerminalIP() {
      java.lang.Object ref = taForTerminalIP_;
      if (ref instanceof String) {
        return (String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    private com.google.protobuf.ByteString getTaForTerminalIPBytes() {
      java.lang.Object ref = taForTerminalIP_;
      if (ref instanceof String) {
        com.google.protobuf.ByteString b = 
            com.google.protobuf.ByteString.copyFromUtf8((String) ref);
    ...
    // required int32 taForTerminalPort = 6;
    public static final int TAFORTERMINALPORT_FIELD_NUMBER = 6;
    private int taForTerminalPort_;
    public boolean hasTaForTerminalPort() {
      return ((bitField0_ & 0x00000020) == 0x00000020);
    }
    public int getTaForTerminalPort() {
      return taForTerminalPort_;
    }
    ...
    public final boolean isInitialized() {
      ...
      if (!hasTaForTerminalIP()) {
        memoizedIsInitialized = 0;
        return false;
      }
      if (!hasTaForTerminalPort()) {
        memoizedIsInitialized = 0;
        return false;
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeBytes(3, getDaIPBytes());
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        output.writeInt32(4, daPort_);
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        output.writeBytes(5, getTaForTerminalIPBytes());
      }
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        output.writeInt32(6, taForTerminalPort_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(3, getDaIPBytes());
      }
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(4, daPort_);
      }
      if (((bitField0_ & 0x00000010) == 0x00000010)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(5, getTaForTerminalIPBytes());
      }
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(6, taForTerminalPort_);
      }
      for (int i = 0; i < paras_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTAOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.internal_static_ConfigForTA_descriptor;
      }
      ...
      // Construct using com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA build() {
        com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA result = new com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA(this);
        ...
        result.taForTerminalIP_ = taForTerminalIP_;
        if (((from_bitField0_ & 0x00000020) == 0x00000020)) {
          to_bitField0_ |= 0x00000020;
        }
        result.taForTerminalPort_ = taForTerminalPort_;
        if (parasBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA.getDefaultInstance()) return this;
        if (other.hasDpIP()) {
        ...
        if (other.hasTaForTerminalIP()) {
          setTaForTerminalIP(other.getTaForTerminalIP());
        }
        if (other.hasTaForTerminalPort()) {
          setTaForTerminalPort(other.getTaForTerminalPort());
        }
        if (parasBuilder_ == null) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 42: {
              ...
              taForTerminalIP_ = input.readBytes();
              break;
            }
            case 48: {
              bitField0_ |= 0x00000020;
              taForTerminalPort_ = input.readInt32();
              break;
            }
            case 58: {
  ...
  bitField0_ |= 0x00000004;
      ...
      public Builder setTaForTerminalIP(String value) {
        if (value == null) {
    throw new NullPointerException();
  }
  bitField0_ |= 0x00000010;
        taForTerminalIP_ = value;
        onChanged();
        return this;
      }
      public Builder clearTaForTerminalIP() {
        bitField0_ = (bitField0_ & ~0x00000010);
        taForTerminalIP_ = getDefaultInstance().getTaForTerminalIP();
        onChanged();
        return this;
      }
      void setTaForTerminalIP(com.google.protobuf.ByteString value) {
        bitField0_ |= 0x00000010;
        taForTerminalIP_ = value;
        onChanged();
      }
      ...
      public Builder setTaForTerminalPort(int value) {
        bitField0_ |= 0x00000020;
        taForTerminalPort_ = value;
        onChanged();
        return this;
      }
      public Builder clearTaForTerminalPort() {
        bitField0_ = (bitField0_ & ~0x00000020);
        taForTerminalPort_ = 0;
        onChanged();
        return this;
      ...
      // @@protoc_insertion_point(builder_scope:ConfigForTA)
    }
    
    static {
      defaultInstance = new ConfigForTA(true);
      defaultInstance.initFields();
    }
    
    // @@protoc_insertion_point(class_scope:ConfigForTA)
  }
  
  private static com.google.protobuf.Descriptors.Descriptor
    internal_static_ConfigForTA_descriptor;
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_ConfigForTA_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n-core/proto/services/ta/java/ConfigForT" +
      "A.proto\0325core/proto/services/common/java" +
      "/ParameterConfig.proto\"\236\001\n\013ConfigForTA\022\014" +
      "\n\004dpIP\030\001 \002(\t\022\016\n\006dpPort\030\002 \002(\005\022\014\n\004daIP\030\003 \002" +
      "(\t\022\016\n\006daPort\030\004 \002(\005\022\027\n\017taForTerminalIP\030\005 " +
      "\002(\t\022\031\n\021taForTerminalPort\030\006 \002(\005\022\037\n\005paras\030" +
      "\007 \003(\0132\020.ParameterConfigBK\n:com.navinfo.o" +
      "pentsp.platform.location.protocol.servic" +
      "es.taB\rLCConfigForTA"
    };
    com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner assigner =
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForTA_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ConfigForTA_descriptor,
              new java.lang.String[] { "DpIP", "DpPort", "DaIP", "DaPort", "TaForTerminalIP", "TaForTerminalPort", "Paras", },
              com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA.class,
              com.navinfo.opentsp.platform.location.protocol.services.ta.LCConfigForTA.ConfigForTA.Builder.class);
          return null;
        }
      };
