...
// source: core/proto/nodecluster/java/ConfigForTA.proto
...
public final class LCConfigForTA {
  ...
  public interface ConfigForTAOrBuilder
    ...
    // required int64 dpCode = 1;
    boolean hasDpCode();
    long getDpCode();
    
    // required int64 daCode = 2;
    boolean hasDaCode();
    long getDaCode();
  ...
  public static final class ConfigForTA extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.internal_static_ConfigForTA_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.internal_static_ConfigForTA_fieldAccessorTable;
    }
    
    private int bitField0_;
    // required int64 dpCode = 1;
    public static final int DPCODE_FIELD_NUMBER = 1;
    private long dpCode_;
    ...
    // required int64 daCode = 2;
    public static final int DACODE_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        output.writeInt64(1, dpCode_);
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeInt64(2, daCode_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt64Size(1, dpCode_);
      }
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt64Size(2, daCode_);
      }
      for (int i = 0; i < paras_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTAOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.internal_static_ConfigForTA_descriptor;
      }
      ...
      // Construct using com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA build() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA result = new com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA.getDefaultInstance()) return this;
        if (other.hasDpCode()) {
          setDpCode(other.getDpCode());
        }
        if (other.hasDaCode()) {
      ...
      public Builder setDpCode(long value) {
        bitField0_ |= 0x00000001;
        dpCode_ = value;
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n-core/proto/nodecluster/java/ConfigForT" +
      "A.proto\0328core/proto/nodecluster/common/j" +
      "ava/ParameterConfig.proto\"N\n\013ConfigForTA" +
      "\022\016\n\006dpCode\030\001 \002(\003\022\016\n\006daCode\030\002 \002(\003\022\037\n\005para" +
      "s\030\003 \003(\0132\020.ParameterConfigBK\n:com.navinfo" +
      ".opentsp.platform.location.protocol.node" +
      "clusterB\rLCConfigForTA"
    };
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForTA_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ConfigForTA_descriptor,
              new java.lang.String[] { "DpCode", "DaCode", "Paras", },
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA.class,
              com.navinfo.opentsp.platform.location.protocol.nodecluster.LCConfigForTA.ConfigForTA.Builder.class);
          return null;
        }
      };
