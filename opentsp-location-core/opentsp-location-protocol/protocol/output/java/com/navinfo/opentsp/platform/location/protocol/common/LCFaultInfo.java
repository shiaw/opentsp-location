...
public final class LCFaultInfo {
  ...
  public interface FaultInfoOrBuilder
    ...
    com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData getGpsLocationData();
    com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationDataOrBuilder getGpsLocationDataOrBuilder();
    
    // repeated .FaultListData faultListData = 2;
    java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData> 
        getFaultListDataList();
    com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData getFaultListData(int index);
    int getFaultListDataCount();
    java.util.List<? extends com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder> 
        getFaultListDataOrBuilderList();
    com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder getFaultListDataOrBuilder(
        int index);
  }
  public static final class FaultInfo extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultInfo_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultInfo_fieldAccessorTable;
    }
    
    private int bitField0_;
    // optional .GpsLocationData gpsLocationData = 1;
    public static final int GPSLOCATIONDATA_FIELD_NUMBER = 1;
    private com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData gpsLocationData_;
    public boolean hasGpsLocationData() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData getGpsLocationData() {
      return gpsLocationData_;
    }
    public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationDataOrBuilder getGpsLocationDataOrBuilder() {
      return gpsLocationData_;
    }
    
    // repeated .FaultListData faultListData = 2;
    public static final int FAULTLISTDATA_FIELD_NUMBER = 2;
    private java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData> faultListData_;
    public java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData> getFaultListDataList() {
      return faultListData_;
    }
    public java.util.List<? extends com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder> 
        getFaultListDataOrBuilderList() {
      return faultListData_;
    }
    ...
    public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData getFaultListData(int index) {
      return faultListData_.get(index);
    }
    public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder getFaultListDataOrBuilder(
        int index) {
      return faultListData_.get(index);
    }
    
    private void initFields() {
      gpsLocationData_ = com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.getDefaultInstance();
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultInfo_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo build() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo result = new com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.Builder subBuilder = com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.newBuilder();
              if (hasGpsLocationData()) {
            ...
            case 18: {
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder subBuilder = com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
      ...
      // optional .GpsLocationData gpsLocationData = 1;
      private com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData gpsLocationData_ = com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.Builder, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationDataOrBuilder> gpsLocationDataBuilder_;
      public boolean hasGpsLocationData() {
        return ((bitField0_ & 0x00000001) == 0x00000001);
      }
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData getGpsLocationData() {
      ...
      public Builder setGpsLocationData(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData value) {
        if (gpsLocationDataBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setGpsLocationData(
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.Builder builderForValue) {
        if (gpsLocationDataBuilder_ == null) {
      ...
      public Builder mergeGpsLocationData(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData value) {
        if (gpsLocationDataBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001) &&
              gpsLocationData_ != com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.getDefaultInstance()) {
            gpsLocationData_ =
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.newBuilder(gpsLocationData_).mergeFrom(value).buildPartial();
          } else {
            gpsLocationData_ = value;
          }
          onChanged();
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.Builder getGpsLocationDataBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
      ...
      private com.google.protobuf.SingleFieldBuilder<
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.Builder, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationDataOrBuilder> 
          getGpsLocationDataFieldBuilder() {
        if (gpsLocationDataBuilder_ == null) {
      ...
      private void ensureFaultListDataIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          faultListData_ = new java.util.ArrayList<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData>(faultListData_);
          bitField0_ |= 0x00000002;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder> faultListDataBuilder_;
      ...
      public Builder setFaultListData(
          int index, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData value) {
        if (faultListDataBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFaultListData(
          int index, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder builderForValue) {
        if (faultListDataBuilder_ == null) {
          ensureFaultListDataIsMutable();
      ...
      public Builder addFaultListData(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData value) {
        if (faultListDataBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addFaultListData(
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder builderForValue) {
        if (faultListDataBuilder_ == null) {
          ensureFaultListDataIsMutable();
      ...
      public Builder addAllFaultListData(
          java.lang.Iterable<? extends com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData> values) {
        if (faultListDataBuilder_ == null) {
          ensureFaultListDataIsMutable();
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder getFaultListDataBuilder(
          int index) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder addFaultListDataBuilder() {
        return getFaultListDataFieldBuilder().addBuilder(
            com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.getDefaultInstance());
      }
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder addFaultListDataBuilder(
          int index) {
        return getFaultListDataFieldBuilder().addBuilder(
            index, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.getDefaultInstance());
      }
      public java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder> 
           getFaultListDataBuilderList() {
        return getFaultListDataFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder> 
          getFaultListDataFieldBuilder() {
        if (faultListDataBuilder_ == null) {
  ...
  public static final class GpsLocationData extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_GpsLocationData_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_GpsLocationData_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_GpsLocationData_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData build() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData result = new com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.getDefaultInstance()) return this;
        if (other.hasGpsTime()) {
  ...
  public interface FaultListDataOrBuilder
    ...
    java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem> 
        getFaultItemList();
    com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem getFaultItem(int index);
    int getFaultItemCount();
    java.util.List<? extends com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder> 
        getFaultItemOrBuilderList();
    com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder getFaultItemOrBuilder(
        int index);
  }
  public static final class FaultListData extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultListData_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultListData_fieldAccessorTable;
    }
    ...
    private java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem> faultItem_;
    public java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem> getFaultItemList() {
      return faultItem_;
    }
    public java.util.List<? extends com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder> 
        getFaultItemOrBuilderList() {
      return faultItem_;
    }
    ...
    public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem getFaultItem(int index) {
      return faultItem_.get(index);
    }
    public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder getFaultItemOrBuilder(
        int index) {
      return faultItem_.get(index);
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultListData_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData build() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData result = new com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 146: {
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder subBuilder = com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
      ...
      private void ensureFaultItemIsMutable() {
        if (!((bitField0_ & 0x00020000) == 0x00020000)) {
          faultItem_ = new java.util.ArrayList<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem>(faultItem_);
          bitField0_ |= 0x00020000;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder> faultItemBuilder_;
      ...
      public Builder setFaultItem(
          int index, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem value) {
        if (faultItemBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFaultItem(
          int index, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder builderForValue) {
        if (faultItemBuilder_ == null) {
          ensureFaultItemIsMutable();
      ...
      public Builder addFaultItem(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem value) {
        if (faultItemBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addFaultItem(
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder builderForValue) {
        if (faultItemBuilder_ == null) {
          ensureFaultItemIsMutable();
      ...
      public Builder addAllFaultItem(
          java.lang.Iterable<? extends com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem> values) {
        if (faultItemBuilder_ == null) {
          ensureFaultItemIsMutable();
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder getFaultItemBuilder(
          int index) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder addFaultItemBuilder() {
        return getFaultItemFieldBuilder().addBuilder(
            com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.getDefaultInstance());
      }
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder addFaultItemBuilder(
          int index) {
        return getFaultItemFieldBuilder().addBuilder(
            index, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.getDefaultInstance());
      }
      public java.util.List<com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder> 
           getFaultItemBuilderList() {
        return getFaultItemFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder, com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder> 
          getFaultItemFieldBuilder() {
        if (faultItemBuilder_ == null) {
  ...
  public static final class FaultItem extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultItem_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultItem_fieldAccessorTable;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItemOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.internal_static_FaultItem_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem build() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem result = new com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_FaultInfo_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_FaultInfo_descriptor,
              new java.lang.String[] { "GpsLocationData", "FaultListData", },
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo.class,
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultInfo.Builder.class);
          internal_static_GpsLocationData_descriptor =
            getDescriptor().getMessageTypes().get(1);
          internal_static_GpsLocationData_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_GpsLocationData_descriptor,
              new java.lang.String[] { "GpsTime", "Latitude", "Longitude", "Height", "Direction", "Speed", },
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.class,
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.GpsLocationData.Builder.class);
          internal_static_FaultListData_descriptor =
            getDescriptor().getMessageTypes().get(2);
          internal_static_FaultListData_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_FaultListData_descriptor,
              new java.lang.String[] { "FaultType", "SubSpeed", "Accelerator", "BrakeSignal", "Rotation", "EngineTurbochargedPressure", "EngineIntakePressure", "EngineExhaustTemperature", "EngineCoolantTemperature", "AccelerationRate", "Gear", "EngineOutputTorque", "Load", "EngineLoad", "VehicleAcceleration", "VehicleSpeedReduction", "FaultCodeCount", "FaultItem", },
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.class,
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultListData.Builder.class);
          internal_static_FaultItem_descriptor =
            getDescriptor().getMessageTypes().get(3);
          internal_static_FaultItem_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_FaultItem_descriptor,
              new java.lang.String[] { "FaultAddr", "SPN", "FMI", },
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.class,
              com.navinfo.opentsp.platform.location.protocol.common.LCFaultInfo.FaultItem.Builder.class);
          return null;
        }
      };
