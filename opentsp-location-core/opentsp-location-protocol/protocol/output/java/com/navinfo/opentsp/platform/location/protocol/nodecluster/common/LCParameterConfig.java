...
public final class LCParameterConfig {
  ...
  public interface ParameterConfigOrBuilder
    ...
    boolean hasTypes();
    com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType getTypes();
  ...
  public static final class ParameterConfig extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.internal_static_ParameterConfig_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.internal_static_ParameterConfig_fieldAccessorTable;
    }
    ...
    public enum ParameterType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType types_;
    public boolean hasTypes() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    public com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType getTypes() {
      return types_;
    }
    ...
    private void initFields() {
      types_ = com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType.all_reconnectTimes;
      values_ = 0;
    }
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig parseFrom(
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.internal_static_ParameterConfig_descriptor;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.getDescriptor();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig getDefaultInstanceForType() {
        return com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.getDefaultInstance();
      }
      
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig build() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig result = buildPartial();
      ...
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig buildPartial() {
        com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig result = new com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig) {
          return mergeFrom((com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig)other);
        } else {
      ...
      public Builder mergeFrom(com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig other) {
        if (other == com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.getDefaultInstance()) return this;
        if (other.hasTypes()) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType value = com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType.valueOf(rawValue);
              if (value == null) {
      ...
      // required .ParameterConfig.ParameterType types = 1;
      private com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType types_ = com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType.all_reconnectTimes;
      public boolean hasTypes() {
        return ((bitField0_ & 0x00000001) == 0x00000001);
      }
      public com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType getTypes() {
      ...
      public Builder setTypes(com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.ParameterType value) {
        if (value == null) {
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ParameterConfig_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.class,
              com.navinfo.opentsp.platform.location.protocol.nodecluster.common.LCParameterConfig.ParameterConfig.Builder.class);
          return null;
        }
      };
