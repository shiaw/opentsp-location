...
com.navinfo.opentsp.platform.location.protocol.terminal.DeleteRectangleAreaAlarm = PROTO.Message("com.navinfo.opentsp.platform.location.protocol.terminal.DeleteRectangleAreaAlarm",{
	areaIdentify: {
		options: {packed:true},
