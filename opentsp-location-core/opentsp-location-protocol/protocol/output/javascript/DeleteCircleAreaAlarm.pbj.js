...
com.navinfo.opentsp.platform.location.protocol.terminal.DeleteCircleAreaAlarm = PROTO.Message("com.navinfo.opentsp.platform.location.protocol.terminal.DeleteCircleAreaAlarm",{
	areaIdentify: {
		options: {packed:true},
