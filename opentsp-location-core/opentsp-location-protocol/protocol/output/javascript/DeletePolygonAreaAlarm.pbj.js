...
com.navinfo.opentsp.platform.location.protocol.terminal.DeletePolygonAreaAlarm = PROTO.Message("com.navinfo.opentsp.platform.location.protocol.terminal.DeletePolygonAreaAlarm",{
	areaIdentify: {
		options: {packed:true},
