...
public class DriverLoginEntity implements Serializable{
	private long _id;
	...
	private List<DriverLogin> dataList;
	...
	public List<DriverLogin> getDataList() {
		return dataList;
	}
	public void setDataList(List<DriverLogin> dataList) {
