...
public final class LCReportErrorNode {
  ...
  public static final class ReportErrorNode extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LCReportErrorNode.internal_static_ReportErrorNode_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LCReportErrorNode.internal_static_ReportErrorNode_fieldAccessorTable;
    }
    ...
    public static ReportErrorNode parseFrom(
    ...
    public static ReportErrorNode parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static ReportErrorNode parseFrom(
    ...
    public static ReportErrorNode parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ReportErrorNode parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ReportErrorNode parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(ReportErrorNode prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return ReportErrorNode.getDescriptor();
      }
      
      public ReportErrorNode getDefaultInstanceForType() {
        return ReportErrorNode.getDefaultInstance();
      }
      
      public ReportErrorNode build() {
        ReportErrorNode result = buildPartial();
      ...
      private ReportErrorNode buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        ReportErrorNode result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public ReportErrorNode buildPartial() {
        ReportErrorNode result = new ReportErrorNode(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ReportErrorNode) {
          return mergeFrom((ReportErrorNode)other);
        } else {
      ...
      public Builder mergeFrom(ReportErrorNode other) {
        if (other == ReportErrorNode.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ReportErrorNode_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ReportErrorNode_descriptor,
              new String[] { "ErrorNodeCode", },
              ReportErrorNode.class,
              ReportErrorNode.Builder.class);
          return null;
        }
      };
