...
public class LcOutRegionLimitSpeedLogEntity implements java.io.Serializable {

	private static final long serialVersionUID = -960808184654521459L;
	private int id;
	/**
	 * 终端标识
	 */
	...
	public String toString() {
		return "LcOutRegionLimitSpeedLogEntity [id=" + id + ", terminal_id="
