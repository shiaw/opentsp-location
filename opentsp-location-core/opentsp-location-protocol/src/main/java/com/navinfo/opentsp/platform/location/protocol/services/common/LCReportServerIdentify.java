...
public final class LCReportServerIdentify {
  ...
  public static final class ReportServerIdentify extends
    ...
    private LCNodeType.NodeType type_;
    public boolean hasType() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    public LCNodeType.NodeType getType() {
      return type_;
    }
    ...
    private void initFields() {
      type_ = LCNodeType.NodeType.ta_jt808_2011;
      nodeCode_ = 0;
    }
    ...
    public static final class Builder extends
      ...
      // required .NodeType type = 1;
      private LCNodeType.NodeType type_ = LCNodeType.NodeType.ta_jt808_2011;
      public boolean hasType() {
        return ((bitField0_ & 0x00000001) == 0x00000001);
      }
      public LCNodeType.NodeType getType() {
      ...
      public Builder setType(LCNodeType.NodeType value) {
        if (value == null) {
