...
public final class LCSubscribeRequestRes {
  ...
  public interface SubscribeRequestResOrBuilder
    ...
    java.util.List<LCRPNodeData.RPNodeData>
        getDatasList();
    LCRPNodeData.RPNodeData getDatas(int index);
    int getDatasCount();
    java.util.List<? extends LCRPNodeData.RPNodeDataOrBuilder>
        getDatasOrBuilderList();
    LCRPNodeData.RPNodeDataOrBuilder getDatasOrBuilder(
            int index);
  ...
  public static final class SubscribeRequestRes extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LCSubscribeRequestRes.internal_static_SubscribeRequestRes_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LCSubscribeRequestRes.internal_static_SubscribeRequestRes_fieldAccessorTable;
    }
    ...
    private java.util.List<LCRPNodeData.RPNodeData> datas_;
    public java.util.List<LCRPNodeData.RPNodeData> getDatasList() {
      return datas_;
    }
    public java.util.List<? extends LCRPNodeData.RPNodeDataOrBuilder>
        getDatasOrBuilderList() {
      return datas_;
    }
    ...
    public LCRPNodeData.RPNodeData getDatas(int index) {
      return datas_.get(index);
    }
    public LCRPNodeData.RPNodeDataOrBuilder getDatasOrBuilder(
        int index) {
      return datas_.get(index);
    }
    ...
    public static SubscribeRequestRes parseFrom(
    ...
    public static SubscribeRequestRes parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static SubscribeRequestRes parseFrom(
    ...
    public static SubscribeRequestRes parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SubscribeRequestRes parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static SubscribeRequestRes parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(SubscribeRequestRes prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return SubscribeRequestRes.getDescriptor();
      }
      
      public SubscribeRequestRes getDefaultInstanceForType() {
        return SubscribeRequestRes.getDefaultInstance();
      }
      
      public SubscribeRequestRes build() {
        SubscribeRequestRes result = buildPartial();
      ...
      private SubscribeRequestRes buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        SubscribeRequestRes result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public SubscribeRequestRes buildPartial() {
        SubscribeRequestRes result = new SubscribeRequestRes(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof SubscribeRequestRes) {
          return mergeFrom((SubscribeRequestRes)other);
        } else {
      ...
      public Builder mergeFrom(SubscribeRequestRes other) {
        if (other == SubscribeRequestRes.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              LCRPNodeData.RPNodeData.Builder subBuilder = LCRPNodeData.RPNodeData.newBuilder();
      ...
      private void ensureDatasIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          datas_ = new java.util.ArrayList<LCRPNodeData.RPNodeData>(datas_);
          bitField0_ |= 0x00000002;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          LCRPNodeData.RPNodeData, LCRPNodeData.RPNodeData.Builder, LCRPNodeData.RPNodeDataOrBuilder> datasBuilder_;
      ...
      public Builder setDatas(
          int index, LCRPNodeData.RPNodeData value) {
        if (datasBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setDatas(
          int index, LCRPNodeData.RPNodeData.Builder builderForValue) {
        if (datasBuilder_ == null) {
          ensureDatasIsMutable();
      ...
      public Builder addDatas(LCRPNodeData.RPNodeData value) {
        if (datasBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addDatas(
          LCRPNodeData.RPNodeData.Builder builderForValue) {
        if (datasBuilder_ == null) {
          ensureDatasIsMutable();
      ...
      public Builder addAllDatas(
          Iterable<? extends LCRPNodeData.RPNodeData> values) {
        if (datasBuilder_ == null) {
          ensureDatasIsMutable();
      ...
      public LCRPNodeData.RPNodeData.Builder getDatasBuilder(
          int index) {
      ...
      public LCRPNodeData.RPNodeData.Builder addDatasBuilder() {
        return getDatasFieldBuilder().addBuilder(
            LCRPNodeData.RPNodeData.getDefaultInstance());
      }
      public LCRPNodeData.RPNodeData.Builder addDatasBuilder(
          int index) {
        return getDatasFieldBuilder().addBuilder(
            index, LCRPNodeData.RPNodeData.getDefaultInstance());
      }
      public java.util.List<LCRPNodeData.RPNodeData.Builder>
           getDatasBuilderList() {
        return getDatasFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          LCRPNodeData.RPNodeData, LCRPNodeData.RPNodeData.Builder, LCRPNodeData.RPNodeDataOrBuilder>
          getDatasFieldBuilder() {
        if (datasBuilder_ == null) {
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_SubscribeRequestRes_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_SubscribeRequestRes_descriptor,
              new String[] { "SerialNumber", "Datas", "TerminalIdentify", },
              SubscribeRequestRes.class,
              SubscribeRequestRes.Builder.class);
          return null;
        }
      };
