...
public final class LCRPNodeData {
  ...
  public interface RPNodeDataOrBuilder
    ...
    boolean hasTypes();
    RPNodeData.ServerType getTypes();
  ...
  public static final class RPNodeData extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LCRPNodeData.internal_static_RPNodeData_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LCRPNodeData.internal_static_RPNodeData_fieldAccessorTable;
    }
    ...
    public enum ServerType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return RPNodeData.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private ServerType types_;
    public boolean hasTypes() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    public ServerType getTypes() {
      return types_;
    }
    
    // required string RpIp = 2;
    public static final int RPIP_FIELD_NUMBER = 2;
    private Object rpIp_;
    ...
    private void initFields() {
      types_ = ServerType.realTimeCommunication;
      rpIp_ = "";
      rpPort_ = 0;
    ...
    public static RPNodeData parseFrom(
    ...
    public static RPNodeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static RPNodeData parseFrom(
    ...
    public static RPNodeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static RPNodeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static RPNodeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(RPNodeData prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return RPNodeData.getDescriptor();
      }
      
      public RPNodeData getDefaultInstanceForType() {
        return RPNodeData.getDefaultInstance();
      }
      
      public RPNodeData build() {
        RPNodeData result = buildPartial();
      ...
      private RPNodeData buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        RPNodeData result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public RPNodeData buildPartial() {
        RPNodeData result = new RPNodeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RPNodeData) {
          return mergeFrom((RPNodeData)other);
        } else {
      ...
      public Builder mergeFrom(RPNodeData other) {
        if (other == RPNodeData.getDefaultInstance()) return this;
        if (other.hasTypes()) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              ServerType value = ServerType.valueOf(rawValue);
              if (value == null) {
      ...
      // required .RPNodeData.ServerType types = 1;
      private ServerType types_ = ServerType.realTimeCommunication;
      public boolean hasTypes() {
        return ((bitField0_ & 0x00000001) == 0x00000001);
      }
      public ServerType getTypes() {
      ...
      public Builder setTypes(ServerType value) {
        if (value == null) {
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_RPNodeData_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_RPNodeData_descriptor,
              new String[] { "Types", "RpIp", "RpPort", "TerminalIdentify", },
              RPNodeData.class,
              RPNodeData.Builder.class);
          return null;
        }
      };
