...
public final class LCDrivingBehaviorAnalysis {
  ...
  public static final class DrivingBehaviorAnalysis extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LCDrivingBehaviorAnalysis.internal_static_DrivingBehaviorAnalysis_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LCDrivingBehaviorAnalysis.internal_static_DrivingBehaviorAnalysis_fieldAccessorTable;
    }
    ...
    private Object deviceIdentity_;
    public boolean hasDeviceIdentity() {
      return ((bitField0_ & 0x00000080) == 0x00000080);
    }
    public String getDeviceIdentity() {
      Object ref = deviceIdentity_;
    ...
    public static DrivingBehaviorAnalysis parseFrom(
    ...
    public static DrivingBehaviorAnalysis parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static DrivingBehaviorAnalysis parseFrom(
    ...
    public static DrivingBehaviorAnalysis parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DrivingBehaviorAnalysis parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DrivingBehaviorAnalysis parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(DrivingBehaviorAnalysis prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return DrivingBehaviorAnalysis.getDescriptor();
      }
      
      public DrivingBehaviorAnalysis getDefaultInstanceForType() {
        return DrivingBehaviorAnalysis.getDefaultInstance();
      }
      
      public DrivingBehaviorAnalysis build() {
        DrivingBehaviorAnalysis result = buildPartial();
      ...
      private DrivingBehaviorAnalysis buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        DrivingBehaviorAnalysis result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public DrivingBehaviorAnalysis buildPartial() {
        DrivingBehaviorAnalysis result = new DrivingBehaviorAnalysis(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DrivingBehaviorAnalysis) {
          return mergeFrom((DrivingBehaviorAnalysis)other);
        } else {
      ...
      public Builder mergeFrom(DrivingBehaviorAnalysis other) {
        if (other == DrivingBehaviorAnalysis.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_DrivingBehaviorAnalysis_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_DrivingBehaviorAnalysis_descriptor,
              new String[] { "TurningAngle", "LowOilDrivingValue", "VehicleSpeedFromEcu", "RpmWhenAlarming", "VelocityChangeValue", "CurrentGearshift", "CurrentRPM", "DeviceIdentity", "BrakeTimes", "ClutchTimes", "RetarderTimes", "AbsTimes", "ReverseTimes", },
              DrivingBehaviorAnalysis.class,
              DrivingBehaviorAnalysis.Builder.class);
          return null;
        }
      };
