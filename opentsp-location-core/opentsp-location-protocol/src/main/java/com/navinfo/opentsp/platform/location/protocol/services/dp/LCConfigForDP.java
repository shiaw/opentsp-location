...
public final class LCConfigForDP {
  ...
  public static final class ConfigForDP extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LCConfigForDP.internal_static_ConfigForDP_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LCConfigForDP.internal_static_ConfigForDP_fieldAccessorTable;
    }
    
    private int bitField0_;
    // required string dpForTaIP = 1;
    public static final int DPFORTAIP_FIELD_NUMBER = 1;
    private Object dpForTaIP_;
    public boolean hasDpForTaIP() {
      return ((bitField0_ & 0x00000001) == 0x00000001);
    }
    public String getDpForTaIP() {
      Object ref = dpForTaIP_;
    ...
    public static ConfigForDP parseFrom(
    ...
    public static ConfigForDP parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static ConfigForDP parseFrom(
    ...
    public static ConfigForDP parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ConfigForDP parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ConfigForDP parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(ConfigForDP prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return ConfigForDP.getDescriptor();
      }
      
      public ConfigForDP getDefaultInstanceForType() {
        return ConfigForDP.getDefaultInstance();
      }
      
      public ConfigForDP build() {
        ConfigForDP result = buildPartial();
      ...
      private ConfigForDP buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        ConfigForDP result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public ConfigForDP buildPartial() {
        ConfigForDP result = new ConfigForDP(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ConfigForDP) {
          return mergeFrom((ConfigForDP)other);
        } else {
      ...
      public Builder mergeFrom(ConfigForDP other) {
        if (other == ConfigForDP.getDefaultInstance()) return this;
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_ConfigForDP_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_ConfigForDP_descriptor,
              new String[] { "DpForTaIP", "DpForTaPort", "DpForRpIP", "DpForRpPort", "DaIP", "DaPort", "EncryptIP", "EncryptPort", "Paras", },
              ConfigForDP.class,
              ConfigForDP.Builder.class);
          return null;
        }
      };
