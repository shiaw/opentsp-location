...
public class ResMileagesSummaryQuery implements Serializable{
    /**
	 * 
	 */
	...
	public ResMileagesSummaryQuery(){}
	public ResMileagesSummaryQuery(int tRecord, int staCode, List<Mileages> resultList){
		totalRords = tRecord;
		statusCode = staCode;
		dataList = resultList;
	}
	...
	public void addData(Mileages value){
