...
@LCTable(name="RouteINOUTAlarm")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class RouteINOUTAlarmEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DARouteINOUTAlarm> dataList;
	/**
	 * 转换为Bson
	 */
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DARouteINOUTAlarm d : this.dataList) {
	...
	public List<DARouteINOUTAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DARouteINOUTAlarm> dataList) {
