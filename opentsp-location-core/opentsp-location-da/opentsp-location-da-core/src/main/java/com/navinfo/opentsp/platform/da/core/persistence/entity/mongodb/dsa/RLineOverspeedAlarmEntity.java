...
@LCTable(name="RLineOverspeedAlarm")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class RLineOverspeedAlarmEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DARLineOverspeedAlarm> dataList;
	/**
	 * 转换为Bson
	 */
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DARLineOverspeedAlarm d : this.dataList) {
	...
	public List<DARLineOverspeedAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DARLineOverspeedAlarm> dataList) {
		this.dataList = dataList;
	}
	public RLineOverspeedAlarmEntity() {
		super();
	}
}
