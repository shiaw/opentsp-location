...
import com.navinfo.opentsp.platform.da.core.persistence.entity.mongodb.dsa.alarm.DARLineOvertimeAlarm;
import com.navinfo.opentsp.platform.da.core.persistence.mongodb.LCMongo;

@LCTable(name="RLineOvertimeAlarm")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class RLineOvertimeAlarmEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DARLineOvertimeAlarm> dataList;
	/**
	 * 转换为Bson
	 */
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DARLineOvertimeAlarm d : this.dataList) {
	...
	public List<DARLineOvertimeAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DARLineOvertimeAlarm> dataList) {
