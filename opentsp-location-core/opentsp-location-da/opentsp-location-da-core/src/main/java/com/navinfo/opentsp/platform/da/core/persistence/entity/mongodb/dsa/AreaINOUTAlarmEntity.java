...
public class AreaINOUTAlarmEntity  extends BaseMongoEntity implements Serializable{
	...
	private List<DAAreaINOUTAlarm> dataList;
	...
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAAreaINOUTAlarm d : this.dataList) {
	...
	public List<DAAreaINOUTAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAAreaINOUTAlarm> dataList) {
		this.dataList = dataList;
	}
	public AreaINOUTAlarmEntity() {
		super();
	}
}
