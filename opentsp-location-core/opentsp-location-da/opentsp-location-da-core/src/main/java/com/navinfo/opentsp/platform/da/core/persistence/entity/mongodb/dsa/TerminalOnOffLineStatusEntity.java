...
@LCTable(name="TerminalOnOffLineStatus")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class TerminalOnOffLineStatusEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DATerminalOnOffLineStatus> dataList;
	/**
	 * 转换为Bson
	 */
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DATerminalOnOffLineStatus d : this.dataList) {
	...
	public List<DATerminalOnOffLineStatus> getDataList() {
		return dataList;
	}
	public void setDataList(List<DATerminalOnOffLineStatus> dataList) {
		this.dataList = dataList;
	}
	public TerminalOnOffLineStatusEntity() {
		super();
	}
}
