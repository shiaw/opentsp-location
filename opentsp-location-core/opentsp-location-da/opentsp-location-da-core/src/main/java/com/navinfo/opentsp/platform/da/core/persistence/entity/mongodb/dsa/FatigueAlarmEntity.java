...
public class FatigueAlarmEntity  extends BaseMongoEntity implements Serializable{
	...
	private List<DAFatigueAlarm> dataList;
	...
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAFatigueAlarm d : this.dataList) {
	...
	public List<DAFatigueAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAFatigueAlarm> dataList) {
		this.dataList = dataList;
	}
	public FatigueAlarmEntity() {
		super();
	}
}
