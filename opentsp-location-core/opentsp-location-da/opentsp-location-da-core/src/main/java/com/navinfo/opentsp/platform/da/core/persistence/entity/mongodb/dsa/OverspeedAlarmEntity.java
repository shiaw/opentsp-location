...
public class OverspeedAlarmEntity  extends BaseMongoEntity implements Serializable{
	...
	private List<DAOverspeedAlarm> dataList;
	...
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAOverspeedAlarm d : this.dataList) {
	...
	public DBObject toDBObject(){
		...
		if( this.dataList!=null){
			topic.put("QB", this.dataList.size());//counts
	...
	public List<DAOverspeedAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAOverspeedAlarm> dataList) {
		this.dataList = dataList;
	}
	public OverspeedAlarmEntity() {
		super();
	}
}
