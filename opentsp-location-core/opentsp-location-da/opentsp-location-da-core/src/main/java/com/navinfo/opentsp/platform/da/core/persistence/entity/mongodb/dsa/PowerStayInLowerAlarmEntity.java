...
@LCTable(name="PowerStayInLowerAlarm")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class PowerStayInLowerAlarmEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DAPowerStayInLowerAlarm> dataList;
	/**
	 * 转换为Bson
	 */
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAPowerStayInLowerAlarm d : this.dataList) {
	...
	public List<DAPowerStayInLowerAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAPowerStayInLowerAlarm> dataList) {
		this.dataList = dataList;
	}
	public PowerStayInLowerAlarmEntity() {
		super();
	}
}
