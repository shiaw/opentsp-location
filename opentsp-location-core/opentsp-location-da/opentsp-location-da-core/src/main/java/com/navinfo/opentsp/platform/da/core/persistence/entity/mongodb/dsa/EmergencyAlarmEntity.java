...
public class EmergencyAlarmEntity  extends BaseMongoEntity implements Serializable{
	...
	private List<DAEmergencyAlarm> dataList;
	/**
	 * 转换为Bson
	 */
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAEmergencyAlarm d : this.dataList) {
	...
	public List<DAEmergencyAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAEmergencyAlarm> dataList) {
		this.dataList = dataList;
	}
	public EmergencyAlarmEntity() {
		super();
	}
}
