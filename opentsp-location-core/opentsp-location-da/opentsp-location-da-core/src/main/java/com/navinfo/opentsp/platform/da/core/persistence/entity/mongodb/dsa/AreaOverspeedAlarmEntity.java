...
@LCTable(name="AreaOverspeedAlarm")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class AreaOverspeedAlarmEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DAAreaOverspeedAlarm> dataList;
	...
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAAreaOverspeedAlarm d : this.dataList) {
	...
	public List<DAAreaOverspeedAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAAreaOverspeedAlarm> dataList) {
