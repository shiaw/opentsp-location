...
@LCTable(name="ElectricPowerOffAlarm")
//@LCDbName(name="DataStatisticAnalysis")
@LCDbName(name= LCMongo.DB.LC_DATA_STATISTIC_ANALYSIS)
@LCDbIndex(name={"AA","KA","HA"})
public class ElectricPowerOffAlarmEntity  extends BaseMongoEntity implements Serializable{
	private long _id;
	...
	private List<DAElectricPowerOffAlarm> dataList;
	...
	public List<DBObject> toBatchDBObject(){
		...
		if(this.dataList!=null&&this.dataList.size()!=0){
			for (DAElectricPowerOffAlarm d : this.dataList) {
	...
	public List<DAElectricPowerOffAlarm> getDataList() {
		return dataList;
	}
	public void setDataList(List<DAElectricPowerOffAlarm> dataList) {
