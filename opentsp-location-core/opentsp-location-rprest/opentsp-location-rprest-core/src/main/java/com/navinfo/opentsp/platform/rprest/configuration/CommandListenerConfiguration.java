package com.navinfo.opentsp.platform.rprest.configuration;
...
import com.navinfo.opentsp.platform.rprest.RpRestModuleConstants;
...
public class CommandListenerConfiguration extends AbstractCommandListenerConfiguration {
    ...
    public Queue commandQueue(RabbitAdmin rabbitAdmin) {
        Queue queue = new Queue(RpRestModuleConstants.QUEUE, false, false, false);
