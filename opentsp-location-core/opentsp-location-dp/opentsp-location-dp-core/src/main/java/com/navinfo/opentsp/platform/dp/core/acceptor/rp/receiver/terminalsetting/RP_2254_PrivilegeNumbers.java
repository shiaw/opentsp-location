...
@RPAnno(id="2254")
public class RP_2254_PrivilegeNumbers extends RPCommand {

	@Override
	public int processor(Packet packet) {
		SettingParameterEntry parameterEntry = new SettingParameterEntry();
		parameterEntry.setCommandCode(AllCommands.Terminal.PrivilegeNumbers_VALUE);
...
//		TerminalParameterCache.getInstance().add(packet.getUniqueMark(), packet.getSerialNumber(), parameterEntry);
		...
		super.terminalOperateLog(parameterEntry.getTerminalId(), AllCommands.Terminal.PrivilegeNumbers_VALUE, packet.getContent());
