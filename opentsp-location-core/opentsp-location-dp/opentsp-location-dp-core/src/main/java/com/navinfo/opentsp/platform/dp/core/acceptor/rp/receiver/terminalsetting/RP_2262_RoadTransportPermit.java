...
@RPAnno(id="2262")
public class RP_2262_RoadTransportPermit extends RPCommand {

	@Override
	public int processor(Packet packet) {
		SettingParameterEntry parameterEntry = new SettingParameterEntry();
		parameterEntry.setCommandCode(AllCommands.Terminal.RoadTransportPermit_VALUE);
...
//		TerminalParameterCache.getInstance().add(packet.getUniqueMark(), packet.getSerialNumber(), parameterEntry);
		super.terminalOperateLog(parameterEntry.getTerminalId(), AllCommands.Terminal.RoadTransportPermit_VALUE, packet.getContent());
