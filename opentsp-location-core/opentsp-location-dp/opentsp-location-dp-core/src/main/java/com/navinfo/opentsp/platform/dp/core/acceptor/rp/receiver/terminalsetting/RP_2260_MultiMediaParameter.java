...
@RPAnno(id="2260")
public class RP_2260_MultiMediaParameter extends RPCommand {

	@Override
	public int processor(Packet packet) {
		SettingParameterEntry parameterEntry = new SettingParameterEntry();
		parameterEntry.setCommandCode(AllCommands.Terminal.MultiMediaParameter_VALUE);
...
//		TerminalParameterCache.getInstance().add(packet.getUniqueMark(), packet.getSerialNumber(), parameterEntry);
		...
		super.terminalOperateLog(parameterEntry.getTerminalId(), AllCommands.Terminal.MultiMediaParameter_VALUE, packet.getContent());
