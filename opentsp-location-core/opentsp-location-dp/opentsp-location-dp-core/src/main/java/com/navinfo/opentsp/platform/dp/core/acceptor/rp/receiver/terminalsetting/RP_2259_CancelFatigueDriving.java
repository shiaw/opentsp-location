...
@RPAnno(id="2259")
public class RP_2259_CancelFatigueDriving extends RPCommand {

	@Override
	public int processor(Packet packet) {
		SettingParameterEntry parameterEntry = new SettingParameterEntry();
		parameterEntry.setCommandCode(AllCommands.Terminal.FatigueDrivingCancel_VALUE);
...
//		TerminalParameterCache.getInstance().add(packet.getUniqueMark(), packet.getSerialNumber(), parameterEntry);
		...
		super.terminalOperateLog(parameterEntry.getTerminalId(), AllCommands.Terminal.FatigueDrivingCancel_VALUE, packet.getContent());
