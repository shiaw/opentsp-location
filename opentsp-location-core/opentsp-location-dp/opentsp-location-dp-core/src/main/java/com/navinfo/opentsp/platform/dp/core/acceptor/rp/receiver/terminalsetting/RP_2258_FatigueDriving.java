...
@RPAnno(id="2258")
public class RP_2258_FatigueDriving extends RPCommand {

	@Override
	public int processor(Packet packet) {
		SettingParameterEntry parameterEntry = new SettingParameterEntry();
		parameterEntry.setCommandCode(AllCommands.Terminal.FatigueDrivingSetting_VALUE);
...
//		TerminalParameterCache.getInstance().add(packet.getUniqueMark(), packet.getSerialNumber(), parameterEntry);
		...
		super.terminalOperateLog(parameterEntry.getTerminalId(), AllCommands.Terminal.FatigueDrivingSetting_VALUE, packet.getContent());
