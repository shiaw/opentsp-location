...
@RPAnno(id="2252")
public class RP_2252_ConnectServerConfig extends RPCommand {

	@Override
	public int processor(Packet packet) {
		SettingParameterEntry parameterEntry = new SettingParameterEntry();
		parameterEntry.setCommandCode(AllCommands.Terminal.ConnectServerConfig_VALUE);
...
//		TerminalParameterCache.getInstance().add(packet.getUniqueMark(), packet.getSerialNumber(), parameterEntry);
		...
		super.terminalOperateLog(parameterEntry.getTerminalId(), AllCommands.Terminal.ConnectServerConfig_VALUE, packet.getContent());
